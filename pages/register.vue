<template>
    ...
    <div class="w-full">
        ...
        <div class="form-container m-auto mt-10">
            <p class="title">register</p>
            <form class="form">
                <div class="input-group">
                    <label for="name">Name</label>
                    <input id="username" v-model="name" type="text" placeholder="Name" required />
                </div>
                <div class="input-group">
                ...
                <button type="submit" style="margin-top:6%;" class="sign">
...
const REGISTER_USER = gql`
  mutation addUser($name: String!, $email: String!, $password: String!) {
    addUser(input: { name: $name, email: $email, password: $password, role: "Admin" }) {
      id
      name
      email
    }
